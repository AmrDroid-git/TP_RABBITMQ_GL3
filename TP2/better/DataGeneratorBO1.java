...
public class DataGeneratorBO1 {
    public static void main(String[] args) {
        String dbUrl = "jdbc:mysql://localhost:3311/bo1_sales_db?useSSL=false&allowPublicKeyRetrieval=true";
        String dbUser = "root";
        String dbPassword = "root";
        String region = "East"; // BO1 uses East
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPassword);
            ...
            System.out.println("DataGeneratorBO1 connected to DB. Inserting every 10 seconds with incremental date...");
            ...
            while (true) {
                ...
                System.out.println("Inserted BO1: " + saleDate + "," + region + "," + product + "," + qty + "," + cost + "," + amt + "," + tax + "," + total);
            ...
            System.out.println("DataGeneratorBO1 interrupted, shutting down.");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
